  ...
  return (
    <React.Fragment>
      ...
      <section className='overflow-hidden min-h-full'>
        <div className='relative z-50 flex items-center justify-between xl:hidden bg-white border-b border-coolGray-100 px-8 py-5 -mx-3'>
        ...
        <div className='navbar-menu z-50 fixed top-0 hidden flex xl:flex flex-col justify-between bg-white border-r border-coolGray-100 max-w-xs w-9/12 h-full overflow-y-auto'>
        ...
        <div className='xl:ml-80'>
            ...
            <div className='flex flex-wrap items-center -m-2'>
              ...
              <div className='w-full md:w-1/2 p-2'>
                <div className='flex flex-wrap justify-end -m-2'>
                  ...
                  <div className='w-full md:w-auto p-2'>
                    <button className='flex items-center justify-center p-3 w-full text-base text-coolGray-500 hover:text-white font-medium bg-coolGray-800 hover:bg-coolGray-900 border border-gray-200 rounded-md shadow-button'>
                      <svg
                        width={24}
                        height={24}
                        viewBox='0 0 24 24'
          ...
          <section className='bg-white p-8 pt-7 pb-6'>
            <div className='flex flex-wrap items-center justify-between pb-5 -mx-2'>
              ...
              <div className='w-full md:w-1/2 px-2'>
                <div className='flex flex-wrap justify-end -m-2'>
                  <div className='w-full md:w-auto p-2'>
                    <button className='w-full px-4 py-2 text-sm text-coolGray-500 font-medium bg-white border border-coolGray-200 hover:border-coolGray-300 rounded-md shadow-button'>
                      Button Secondary
                    </button>
                  </div>
                  <div className='w-full md:w-auto p-2'>
                    <button className='w-full px-4 py-2 text-sm text-white font-medium bg-green-500 hover:bg-green-600 border border-green-600 rounded-md shadow-button'>
                      Button CTA
                    </button>
                  </div>
                </div>
            ...
            <ul className='flex flex-wrap border-b border-coolGray-100'>
              <li>
                <a
                  className='block px-4 pb-4 text-sm font-medium text-coolGray-500 hover:text-green-500 border-b-2 border-transparent hover:border-green-500'
                  href='#'
                >
                  Active
                </a>
