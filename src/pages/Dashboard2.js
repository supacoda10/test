                ...
                <div className='p-8 bg-white border border-coolGray-100 rounded-md shadow-dashboard'>
                  <div className='flex flex-wrap items-center justify-between -m-1'>
                    <div className='w-auto p-1'>
                      <h2 className='font-semibold text-2xl text-black tracking-tighter'>
                        24.7k
                      </h2>
                    </div>
                    <div className='w-auto p-1'>
              ...
              <div className='w-full md:w-1/2 xl:w-1/4 p-3'>
                <div className='p-8 bg-white border border-coolGray-100 rounded-md shadow-dashboard'>
                  <div className='flex flex-wrap items-center justify-between -m-1'>
                    ...
                    <div className='w-auto p-1'>
                      <div className='flex items-center px-2 py-1 text-yellow-500 font-medium text-xs bg-yellow-100 rounded-full shadow-sm'>
                        <p>-7%</p>
                      </div>
                    </div>
                  </div>
            ...
            <div className='flex flex-wrap -m-3'>
              <div className='w-full lg:w-1/2 xl:w-3/4 p-3'>
                <div className='p-6 h-full border border-coolGray-100 overflow-hidden bg-white rounded-md shadow-dashboard'>
                  ...
                  <div className='relative xl:top-11'>
                    <div className='chart-graph5-area' />
                  </div>
                </div>
              </div>
              <div className='w-full lg:w-1/2 xl:w-1/4 p-3'>
                <div className='p-6 pb-4 h-full border border-coolGray-100 bg-white rounded-md shadow-dashboard'>
                  ...
                  <div className='mb-3 border border-coolGray-100 rounded-md'>
                    <div className='chart-graph5-area2' />
                  </div>
                  ...
                  <a
                    ...
                    href='#'
                  >
                    <p className='mr-1'>View more pages</p>
                    <svg
                      width={12}
                      height={12}
                      viewBox='0 0 12 12'
