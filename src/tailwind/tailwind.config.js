module.exports = {
    ...
    theme: {
        ...
        backgroundImage: {
            ...
            'gradient': 'url("../../basko-assets/images/gradient.png"); background-repeat: no-repeat; background-size: cover;'
          },
        ...
        boxShadow: {
            ...
            '3xl': '0px 2.97872px 59.5745px rgba(0, 0, 0, 0.08)',
        ...
        fontFamily: {
            ...
            heading: '"Sentient", ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, "Helvetica Neue", Arial, "Noto Sans", sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji"',
